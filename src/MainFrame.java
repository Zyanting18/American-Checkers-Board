...
public class MainFrame extends JFrame implements ActionListener, MouseMotionListener, MouseListener {
	...
	JPanel boardBg;// Assign1, Board background layer
	JLayeredPane lp;// Assign1, JFrame layering object
	JPanel body;// Assign1, Pieces layer
	JLabel t;// Assign1, Message
	JButton switcher;// Assign1, switcher button
	JButton confirm;// Assign1, confirm button
	GridLayout gridLayout;// Assign1, Board layout
	GameStatus status = new GameStatus();  // Assign2, Game status
	String activePlayer = new String();// Assign2
	String order[] = { "A8", "B8", "C8", "D8", "E8", "F8", "G8", "H8", "A7",
			...
			"F2", "G2", "H2", "A1", "B1", "C1", "D1", "E1", "F1", "G1", "H1" };// Assign1, board position names

	ChessPiece blackPieces[] = new ChessPiece[12];// Assign1, Black pieces collection
	ChessPiece whitePieces[] = new ChessPiece[12];// Assign1, White pieces collection
	ChessPiece spacePieces[] = new ChessPiece[64];// Assign1, No pieces collection

	HashMap<String, ChessPiece> piece = new HashMap<String, ChessPiece>();// Assign1, all pieces on board temporarily, Assign1 is Vector, Assign2 change to HashMap
	HashMap<String, ChessBoardBlock> board = new HashMap<String, ChessBoardBlock>();// Assign1, board blocks
	...
	public MainFrame(String arg0) {
		...
		MenuItem f1 = new MenuItem(MenuItems.items[4]);
		MenuItem f2 = new MenuItem(MenuItems.items[5]);
